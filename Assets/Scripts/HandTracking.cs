...
public class HandTrackingScript : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        axis.transform.position = handIndexTipTransform.position;
        axis.transform.forward = handIndexTipTransform.forward;
        axis.transform.right = handIndexTipTransform.right;
        axis.transform.up = handIndexTipTransform.up;
        ...
        if (leftHand.IsTracked)
        {
            ...
            {
                //initialDist =  this.transform.position - leftHand.transform.position;
